...
<body>
    ...
    <div class="main-content">
        ...
        <section>
            <br>
            <article>witamy na stronioe MTHW</article>
        </section>
        <section>
            <article>Strona ta pomoże wam przy organizowaniu gier na kulturalnych spotkaniach przy napoju wyskokowym.</article>

        </section>
        <section>
            <article>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut harum tempora voluptas nulla? In autem asperiores nihil quas impedit, sed molestias deserunt facere laborum quae omnis vel doloremque quod rem.</article>
            <article>Sapiente ab velit in. Cum provident vitae voluptate fugit sint illo qui error repudiandae aliquam obcaecati! Veritatis debitis, vitae cupiditate facere veniam dignissimos maiores alias reprehenderit non? Quaerat, modi deserunt?</article>
            <article>Officiis laborum quam nisi similique dolorum. Quidem dolore rerum tempore distinctio excepturi, velit vero delectus, nobis vel consequatur vitae, aperiam optio inventore rem consequuntur facilis iusto eligendi officia in numquam!</article>
        </section>
        <section>
            <article>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut harum tempora voluptas nulla? In autem asperiores nihil quas impedit, sed molestias deserunt facere laborum quae omnis vel doloremque quod rem.</article>
            <article>Sapiente ab velit in. Cum provident vitae voluptate fugit sint illo qui error repudiandae aliquam obcaecati! Veritatis debitis, vitae cupiditate facere veniam dignissimos maiores alias reprehenderit non? Quaerat, modi deserunt?</article>
